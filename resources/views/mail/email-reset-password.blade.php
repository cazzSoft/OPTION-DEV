...
<html lang="en">
  ...
  <title>Reset password Option2Health</title>
  ...
  <body>
      ...
      <div class="content">
        ...
        <div class="nav"> 
            ...
            <div  class="content-user"> 
              ...
              <div class="div-text-user">
                <span class="name"> @if(isset($array)) {{Str::limit($array['user'], 23)}} @endif</span>
              </div>
        ...
        <div class="hr"></div>
        <div class="text-body">
          <p ><small><b>Dónde y cuándo sucedió</b></small> </p>
          <p> <small><b>Fecha</b>:</small> <br> <small style="color: #606060;">{{$array['fecha']}}</small></p>
          <p> <small><b>Sistema operativo</b>:</small> <br> <small style="color: #606060;">{{$array['so']}}</small></p>
          <p> <small><b>Navegador</b>:</small> <br> <small style="color: #606060;">{{$array['naveg']}}</small></p>
