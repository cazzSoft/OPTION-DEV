...
<div class="container-fluid ">
    <div class="row  justify-content-start mt-3">
            ...
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 p-3 ">
                   <div class="text-center ml-5">
                         <img class=" img-fluid img-circle img-bordered-xs " src="https://picsum.photos/300/300" alt="User profile picture">
                         <span style="position: absolute; left: 74%; top: 65%; cursor: pointer;" class="bg-white p-2 img-circle elevation-3"><i class="fas fa-plus text-info p-2 "></i></span>
                         
                   </div>
                </div>
                <div class="col col-lg-6 bg-white p-3 ">
                    <p class="h4" >  <b>{{$data->name}}</b>  <i class="far fa-edit ml-3 " style="cursor:pointer;"  id="btn_action"></i></p>
                    <div class="p-1 text-left info_p">
                        ...
                        <dl class="mt-4">
                            ...
                            <dd>{{$data->fecha_nacimiento}} Tienes: {{ \Carbon\Carbon::parse($data->fecha_nacimiento)->age}} años </dd>
                        </dl>
                        <dl class="mt-4">
                            <dd>Télefono:</dd>
                            <dd>{{$data->telefono}} </dd>
                        ...
                        <dl class="mt-4">
                            <dd>Genero:</dd>
                            <dd>@if($data->genero=='1') Masculino @else Femenino @endif </dd>
                        </dl>
        ...
        <div class="col-xl-6 col-md-7 col-sm-12">
            <nav class="w-100 ">
              <div class="nav nav-tabs border-0 d-flex justify-content-left " id="product-tab" role="tablist">
