...
class HomeListenerMasInfo
{
    ...
    public function handle(HomeEvenMasInfo $event)
    {
         //guardamos actividad
        $user=$event->data;
        ...
        $dataRegistro=[
                        'descripcion'=>'Enfermedades de interes',
                        'icon'=>'fas fa-search-plus',
                        'color'=>$color[$i],
                        'tipo'=>3
                    ];
        $dataActividad=[
                        'descripcion'=>auth()->user()->name.' Dio clic en "Ver más" del artículo ',
                        'iduser'=>$user['iduser'],
                        'last_logged_at'=> null,
                        'last_login'=> null,
