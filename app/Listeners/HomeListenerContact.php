...
class HomeListenerContact
{
    ...
    public function handle(HomeEventContact $event)
    {
        ...
        $dataRegistro=[
                        'descripcion'=>'Interés de contacto',
                        'icon'=>'far fa-id-card',
                        'color'=>$color[$i],
                        'tipo'=>7
                    ];
        $dataActividad=[
                        ...
                        'descripcion'=>auth()->user()->name.' dio clic en " '.$user['contact'].' del Artículo'.$articuloName.'"  '.$mytime->toTimeString(),
                        'iduser'=>$user['iduser'],
                        'last_logged_at'=> null,
                        'last_login'=> null,
